...
This document is temporary migration scaffolding. Delete it, along with [astro-migration-phase-1.md](./astro-migration-phase-1.md), once the Astro migration is fully implemented, tested, reviewed, and asserted as correct.
