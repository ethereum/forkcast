      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <div className="mb-6 relative">
          ...
          <div className="flex items-center justify-between mt-4 flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 text-xs font-medium rounded-md transition-all ${
                      selectedFilter === option.value
                        ? activeColors[
                            option.value as keyof typeof activeColors
                          ]
                        : inactiveColors[
                            option.value as keyof typeof inactiveColors
                          ]
                    }`}
                  >
                    {option.label}
            ...
            >
              <div
                className={`w-1.5 h-1.5 rounded-full ${showEvents ? "bg-white dark:bg-slate-900" : "bg-slate-500 dark:bg-slate-400"}`}
              ></div>
          ...
          <div className="space-y-3">
            {(() => {
              ...
              return sortedItems.map((item, index) => {
                ...
                const yearString = itemDate.toLocaleDateString("en-US", {
                  year: "numeric",
                });
                ...
                const wasPreviousUpcoming =
                  index > 0
                    ? (() => {
                        const [prevYear, prevMonth, prevDay] = sortedItems[
                          index - 1
                        ].date
                          .split("-")
                          .map(Number);
                ...
                const showTodayDivider =
                  !hasCrossedToday && wasPreviousUpcoming && !isUpcoming;
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-3">
                                    <span
                                      className={`text-xs font-medium px-2 py-0.5 rounded-full ${upcomingCallTypeBadgeColors[upcomingCall.type]}`}
                                    >
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  <span
                                    className={`text-xs font-medium px-2 py-0.5 rounded-full ${callTypeBadgeColors[call.type]}`}
                                  >
