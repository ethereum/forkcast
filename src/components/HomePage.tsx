    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 text-center relative">
          ...
          <Link
            to="/"
            className="text-4xl font-serif bg-gradient-to-r from-purple-600 via-blue-600 to-purple-800 bg-clip-text text-transparent hover:from-purple-700 hover:via-blue-700 hover:to-purple-900 transition-all duration-200 mb-2 tracking-tight inline-block"
          >
            Forkcast
          </Link>
          ...
          {upgrades.map((upgrade) => {
            const cardContent = (
              <>
                ...
                <p
                  className={`text-sm leading-relaxed mb-4 ${upgrade.disabled ? "text-slate-400 dark:text-slate-500" : "text-slate-600 dark:text-slate-300"}`}
                >
                  {upgrade.tagline}
                </p>

                <div
                  className={`text-xs ${upgrade.disabled ? "text-slate-400 dark:text-slate-500" : "text-slate-500 dark:text-slate-400"}`}
                >
