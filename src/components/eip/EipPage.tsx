...
export const EipPage: React.FC = () => {
  ...
  // View mode: "analysis" shows curated content, "spec" shows raw markdown
  const [viewMode, setViewMode] = useState<'analysis' | 'spec'>(eip?.curated ? 'analysis' : 'spec');
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    setViewMode(eip?.curated ? 'analysis' : 'spec');
  }, [id, eip?.curated]);
              ...
              <>
                ...
                {specContent && !specLoading && (
                  <div className="prose prose-sm prose-slate dark:prose-invert max-w-none
                    ...
                    prose-code:text-sm prose-code:bg-slate-100 dark:prose-code:bg-slate-700 prose-code:px-1 prose-code:py-0.5 prose-code:rounded
