  ...
  return (
    <div className="p-6 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700 rounded">
      ...
      <p className="text-indigo-800 dark:text-indigo-200 text-xs leading-relaxed mb-3">
        Client teams publish their perspectives on headliner selection. These
        viewpoints are especially important as these teams will implement and
        maintain the chosen features.
      </p>
          ...
          return (
            <div
              ...
              onClick={() =>
                ...
                onLinkClick?.(perspective.blogPostUrl)
              }
            >
              <span
