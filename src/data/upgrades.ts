...
export const networkUpgrades: NetworkUpgrade[] = [
  ...
  },
  {
    ...
    name: "Fusaka Upgrade",
    description:
      'Major improvements to Ethereum\'s scalability and user experience, including PeerDAS for enhanced data availability. Named after the combination of "Fulu" (consensus layer upgrade, named after a star) and "Osaka" (execution layer upgrade, named after a Devcon location).',
    tagline:
      "PeerDAS enables nodes to specialize in storing different data pieces while maintaining security, dramatically increasing data capacity for Layer 2 networks and improving overall scalability.",
    status: "Upcoming",
  ...
  },
  {
    ...
    clientTeamPerspectives: [
      ...
      },
      {
        ...
        teamType: "EL",
        blogPostUrl:
          "https://github.com/ethereum/pm/issues/1610#issuecomment-3073521193",
      },
      {
        teamName: "Grandine",
        teamType: "CL",
        blogPostUrl:
          "https://github.com/ethereum/pm/issues/1610#issuecomment-3078680887",
      },
      {
        teamName: "Lighthouse",
        teamType: "CL",
      ...
      },
      {
        ...
        teamType: "CL",
        blogPostUrl:
          "https://blog.chainsafe.io/lodestars-glamsterdam-headliner-vision/",
      },
      {
        teamName: "Nethermind",
        teamType: "EL",
